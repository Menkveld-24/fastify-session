...
declare class Session<T extends SessionData = SessionData> {
     ...
     */
    reload(request: FastifyRequest | IncomingMessage): Promise<void>;
...
export { CRYPTO_SPLIT_CHAR, ErrorWithCode, FastifySessionOptions, HMAC, Hmac, MemoryStore, SecretKey, Session, SessionCrypto, SessionData, SessionStore, createError, _default as default };
